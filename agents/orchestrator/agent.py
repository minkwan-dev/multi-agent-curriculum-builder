...
# ADK A2A: agent card is served at /a2a/<app_name>/.well-known/agent-card.json
researcher_url = os.environ.get(
    "RESEARCHER_AGENT_CARD_URL",
    "http://127.0.0.1:8001/a2a/researcher/.well-known/agent-card.json",
)
...
judge_url = os.environ.get(
    ...
    "http://127.0.0.1:8002/a2a/judge/.well-known/agent-card.json",
)
...
content_builder_url = os.environ.get(
    ...
    "http://127.0.0.1:8003/a2a/content_builder/.well-known/agent-card.json",
)
